...
data Memoize m a where
  ...
  UnsafeMemoizeMulti    :: (HasCallStack, Semigroup (f (b,a)), Container f, Typeable a)
...
multi :: forall f b a m r (rInitial :: EffectRow) w .
  (HasCallStack, Semigroup (f (b, a)), Container f, Typeable a, Members '[MemoizeCacheEffect, Log, GhcTime] r)
...
runMemoizedMultiContext :: (HasCallStack, Semigroup (f (b,a)), Container f, Members '[ErrorE, Memoize] r, Typeable a) =>
...
runMemoizedMulti :: (HasCallStack, Semigroup (f (b,a)), Container f, Members '[ErrorE, Memoize] r, Typeable a) =>
